...
<head>
  ...
  <title>Jack All Trade Shop | Yorozuya</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>J</b>AT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Jack<b>AllTrade</b>Shop</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="#" class="btn btn-danger btn-sm btn-flat"><span class="fa fa-sign-out"></span>Sign out</a>
                </div>
              </li>
            </ul>
          </li>
